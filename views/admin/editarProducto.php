        ...
        <form action="../../controllers/editarProducto.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="precios-grid">
                <div class="precio-item">
                    ...
                    <input type="number" name="stock_normal" min="0" required value="<?= htmlspecialchars($stock_normal) ?>">
                </div>
                <div class="precio-item">
                    <label>Stock Jumbo:</label>
                    <input type="number" name="stock_jumbo" min="0" required value="<?= htmlspecialchars($stock_jumbo) ?>">
                </div>
            </div>
